...
int main() {
	...
	//transform(s1.begin(), s1.end(), s1.begin(), ::tolower); //could not find a way to simply replace one letter at a time with its lowercase version using string.replace and tolower
	...
	//		std::cout << "*Bang Bang*, gotcha noob";
	//	}
	//}
